...
| Analoge Monduhr | Live-Status öffnen, Uhrzeit mit Windows vergleichen, Randstriche und Zeigerspitzen ansehen, direkt auf den Mond rechtsklicken und `Roten Sekundenzeiger anzeigen` zweimal umschalten | Stunde und Minute stimmen mit Windows überein; vier breite und acht schmale Stundenmarken bleiben dezent; Stunden- und Minutenzeiger laufen spitz zu; der rote Sekundenzeiger endet in einer kurzen Pfeilspitze, verschwindet und erscheint sofort; Temperatur bleibt über allen Zeigern lesbar; die letzte Auswahl bleibt nach erneutem Öffnen erhalten |
